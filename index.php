...
<!-- Main Container -->
<div class="container-fluid" style=" background-color: #003333; background-position: center; background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
            ...
            <div class="floating-area">
             ...
             <!-- Texts in home page with heading and sub texts-->
                  <div class="animated slideInRight">
                   ...
                   <br> Find the job meant for you. <b style="color: #e9c46a"></b>
                         ...
                         <button type="button" class="btn" style="width:120px; height:40px;  background-color:#e9c46a; border-radius: 0 !important;"> 
                             <a href = "mailto: kishankumar8166@gmail.com" style="color:black;">  Say Hello! </a>
                         </button>
                         </div>
                            ...
                            if(isset($_GET['category']))
                             ...
                             ?>
                                ...
                                <div class="col-md-4 crd" style="margin: 20px; background-color:#257059; padding: 20px;">
                                    ...
                                    <h5><?php echo $desc;?></h5>
                                    <!-- ------------------------------------------------------------------ -->
                                    <h5><b style="color:#F8D4A7">Experience Required (in year):</b>
                                    <?php echo $minexp;?></h5>
                                    <!-- ------------------------------------------------------------------ -->
